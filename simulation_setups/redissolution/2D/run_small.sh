...
cd /Users/jingxuandeng/phd/KRG/research/diss_pre_ML/DATA/2D_test/100x100 || exit
...
kappa=1
kappa2=0.1
dmin=0.01 # was 0.001 (the larger d_min the easier to get clog)
cut=true
los=107
...
do
for kappa2 in 0.1 #0.1 1 10
do
for kappa in 0.1 # 0.1 1 10
do
  for gamma in  0.75
  do
  (
                param=Da-$Da-d0-$d0-gamma-$gamma-kappa-$kappa-kappa2-$kappa2
